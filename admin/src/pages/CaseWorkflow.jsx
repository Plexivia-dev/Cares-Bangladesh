...
export default function CaseWorkflow() {
  ...
  return (
    <div className="space-y-6 pb-16 animate-in fade-in duration-200">
      ...
      {/* Main Content Area */}
      {loading ? (
        <div className="py-32 flex flex-col items-center justify-center space-y-3 bg-card border border-border rounded-lg">
          <Loader2 className="size-8 text-primary animate-spin" />
          <p className="text-xs font-bold text-muted-foreground">Loading Pipeline Cards...</p>
        </div>
      ) : filteredCases.length === 0 ? (
        <div className="py-24 text-center text-muted-foreground bg-card border border-border rounded-lg flex flex-col items-center justify-center gap-2">
