...
export function UserProfileSettingsPage({ initialTab = 'profile', onProfileUpdated = null }) {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-16 animate-in fade-in duration-200">
      {/* Top Banner Card */}
      <div className="bg-card border border-border p-6 rounded-lg shadow-xs relative overflow-hidden">
      ...
      {activeTab === 'profile' && (
        <form onSubmit={handleSaveProfile} className="space-y-6">
          ...
          <div className="bg-card border border-border p-6 rounded-lg shadow-xs space-y-4">
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Cares Bangladesh, Dhaka, Bangladesh"
                  className="h-10 text-xs bg-muted/40 border-border rounded-xl"
                />
              </div>
            </div>
      ...
      {activeTab === 'security' && (
        <form onSubmit={handleChangePassword} className="bg-card border border-border p-6 rounded-lg shadow-xs space-y-5">
          <div>
            <h2 className="text-sm font-black text-foreground flex items-center gap-2">
