...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-lg border border-black/10 bg-white shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 text-black">
          {/* Header */}
