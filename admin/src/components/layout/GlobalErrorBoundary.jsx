    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen w-full bg-background flex items-center justify-center p-6 select-none font-sans text-foreground">
          <div className="max-w-lg w-full bg-card border border-border p-8 rounded-xl shadow-2xl space-y-6 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-rose-500/10 text-rose-500 border border-rose-500/20 mx-auto">
