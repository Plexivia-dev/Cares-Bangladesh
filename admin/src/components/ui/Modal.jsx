...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/60 backdrop-blur-xs overflow-hidden animate-in fade-in duration-200">
      ...
      <div
        className={cn(
          'relative w-full bg-white text-black border border-black/10 rounded-xl shadow-2xl overflow-hidden z-10 flex flex-col my-auto transition-all transform animate-in zoom-in-95 duration-200',
          height,
          maxWidth,
          className
        )}
