...
const currentSlug = 'best-behavior-therapy-dhaka-bangladesh';

export async function generateMetadata() {
  const seo = seoMetadata[currentSlug] || {};
  return {
    title: seo.title || 'ABA (Applied Behavior Analysis) Therapy | Cares Bangladesh',
    description: seo.description || 'Evidence-based behavioral intervention to improve positive social behaviors, focus, communication, and reduce challenging behaviors.',
    alternates: {
      canonical: seo.canonical || 'https://caresbangladesh.com/' + currentSlug,
    },
    openGraph: {
      title: seo.openGraphTitle || seo.title || 'ABA (Applied Behavior Analysis) Therapy',
