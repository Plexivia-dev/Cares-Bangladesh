...
const currentSlug = 'educational-consutancy';

export async function generateMetadata() {
  const seo = seoMetadata[currentSlug] || {};
  return {
    title: seo.title || 'Educational Consultancy & Guidance | Cares Bangladesh',
    description: seo.description || 'Comprehensive assessment, school placement advice, and parental guidance for children with special educational needs.',
    alternates: {
      canonical: seo.canonical || 'https://caresbangladesh.com/' + currentSlug,
    },
    openGraph: {
      title: seo.openGraphTitle || seo.title || 'Educational Consultancy & Guidance',
      description: seo.openGraphDescription || seo.description,
      url: 'https://caresbangladesh.com/' + currentSlug,
      images: [{ url: seo.openGraphImage || '/assets/img/education-big.png' }],
    },
  };
}

export default function ServicePage() {
  const prog = programs.find((p) => p.slug === currentSlug) || {"id":"educational-consultancy","title":"Educational Consultancy & Guidance","slug":"educational-consutancy","shortDescription":"Comprehensive assessment, school placement advice, and parental guidance for children with special educational needs.","badge":"Consultancy & Guidance","icon":"Compass","bannerImage":"/assets/img/education-big.png","features":["Detailed developmental and educational assessments","School readiness and mainstream inclusion consultation","Parental counseling and home-support strategies"],"faqs":[{"question":"Who should seek educational consultancy?","answer":"Parents looking for guidance on school readiness, specialized intervention, or selecting the right academic environment for their child."}]};
