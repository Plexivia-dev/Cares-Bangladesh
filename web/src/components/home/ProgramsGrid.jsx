    ...
    <section className="py-24 bg-gradient-to-b from-amber-50/40 via-white to-sky-50/40 relative">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-18">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-amber-100/90 text-amber-900 text-xs font-bold font-sister shadow-xs tracking-wider">
                ...
                <div className="p-7 pt-4">
                  <Link href={`/${prog.slug}`} className="w-full block">
                    ...
                    >
                      ...
                      <span className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center group-hover/btn:translate-x-1.5 transition-transform duration-300">
