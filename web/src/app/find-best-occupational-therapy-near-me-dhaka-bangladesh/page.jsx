...
const currentSlug = 'find-best-occupational-therapy-near-me-dhaka-bangladesh';

export async function generateMetadata() {
  const seo = seoMetadata[currentSlug] || {};
  return {
    title: seo.title || 'Occupational Therapy (OT) | Cares Bangladesh',
    description: seo.description || 'Helping children develop fine motor skills, sensory processing abilities, hand-eye coordination, and daily life independence.',
    alternates: {
      canonical: seo.canonical || 'https://caresbangladesh.com/' + currentSlug,
    },
    openGraph: {
      title: seo.openGraphTitle || seo.title || 'Occupational Therapy (OT)',
      description: seo.openGraphDescription || seo.description,
      url: 'https://caresbangladesh.com/' + currentSlug,
      images: [{ url: seo.openGraphImage || '/uploads/2025/01/Service-Banner_-Occupational-Therapy-01.png' }],
    },
  };
}

export default function ServicePage() {
  const prog = programs.find((p) => p.slug === currentSlug) || {"id":"occupational-therapy","title":"Occupational Therapy (OT)","slug":"find-best-occupational-therapy-near-me-dhaka-bangladesh","shortDescription":"Helping children develop fine motor skills, sensory processing abilities, hand-eye coordination, and daily life independence.","badge":"Motor Skills & Independence","icon":"Activity","bannerImage":"/uploads/2025/01/Service-Banner_-Occupational-Therapy-01.png","features":["Fine and gross motor skills enhancement through therapeutic play","Sensory Integration Therapy for sensory processing challenges","Self-care training (dressing, feeding, grooming, writing)","Visual-spatial awareness and bilateral coordination exercises","Adaptive equipment recommendations and environmental modifications"],"faqs":[{"question":"How does Occupational Therapy help my child?","answer":"Occupational Therapy helps children participate in the things they want and need to do through the therapeutic use of everyday activities (occupations)."},{"question":"What is Sensory Integration?","answer":"Sensory integration is how our brain organizes and processes information from our senses (touch, movement, body awareness, sight, sound). OT helps children process sensory inputs effectively."}]};
