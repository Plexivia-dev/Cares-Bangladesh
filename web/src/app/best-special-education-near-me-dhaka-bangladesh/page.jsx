...
const currentSlug = 'best-special-education-near-me-dhaka-bangladesh';

export async function generateMetadata() {
  const seo = seoMetadata[currentSlug] || {};
  return {
    title: seo.title || 'Special Education Program | Cares Bangladesh',
    description: seo.description || 'Tailored educational curricula designed for neurodiverse learners, ensuring every child learns at their own pace.',
    alternates: {
      canonical: seo.canonical || 'https://caresbangladesh.com/' + currentSlug,
    },
    openGraph: {
      title: seo.openGraphTitle || seo.title || 'Special Education Program',
      description: seo.openGraphDescription || seo.description,
      url: 'https://caresbangladesh.com/' + currentSlug,
      images: [{ url: seo.openGraphImage || '/uploads/2025/01/Service-Banner_ABA-Therapy-01.png' }],
    },
  };
}
...
const ServicePage = () => {
  const prog = programs.find((p) => p.slug === currentSlug) || {"id":"special-education","title":"Special Education Program","slug":"best-special-education-near-me-dhaka-bangladesh","shortDescription":"Tailored educational curricula designed for neurodiverse learners, ensuring every child learns at their own pace.","badge":"Specialized Learning","icon":"Sparkles","bannerImage":"/uploads/2025/01/Service-Banner_Special-Education-01.png","features":["Individualized Education Plans (IEP) customized for each learner","Multi-sensory teaching methodologies","Functional academic and practical life skills training","Close collaboration between special educators, therapists, and parents"],"faqs":[{"question":"What is an IEP?","answer":"An Individualized Education Plan (IEP) is a personalized educational roadmap crafted for a specific child to target their unique learning goals and milestones."}]};
